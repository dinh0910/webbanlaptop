...
namespace webbanlaptop.Areas.Admin.Controllers
{
    ...
    public class ThongSosController : Controller
    {
        ...
        {
            var webbanlaptopContext = _context.ThongSo.Include(t => t.SanPhams).Include(t => t.TenThongSos);
        ...
        public async Task<IActionResult> Create([Bind("ThongSoID,SanPhamID,TenThongSoID,NoiDung")] ThongSo thongSo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ThongSoID,SanPhamID,TenThongSoID,NoiDung")] ThongSo thongSo)
        {
