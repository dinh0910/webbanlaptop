...
namespace webbanlaptop.Areas.Admin.Controllers
{
    ...
    public class DonDatHangsController : Controller
    {
        ...
        {
            var webbanlaptopContext = _context.DonDatHang.Include(d => d.HinhThucThanhToans);
        ...
        public async Task<IActionResult> Create([Bind("DonDatHangID,NgayLap,DiaChi,SoDienThoai,Email,GhiChu,TienShip,TongTien,DaVanChuyen,HuyDon,HinhThucThanhToanID")] DonDatHang donDatHang)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("DonDatHangID,NgayLap,DiaChi,SoDienThoai,Email,GhiChu,TienShip,TongTien,DaVanChuyen,HuyDon,HinhThucThanhToanID")] DonDatHang donDatHang)
        {
